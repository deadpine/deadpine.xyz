    ...
    <section id="editorial" className={cn(HERO_MIN, "bg-[#F3F1F0] text-black")}>
      ...
      <div className="flex flex-1 flex-col justify-between px-10 pb-10 pt-16">
        ...
        <div className="flex items-end justify-between gap-10">
          <p className="max-w-sm font-sans text-sm leading-snug text-stone-400">
      ...
      <div className="flex flex-1 flex-col justify-end px-10 pb-10">
        <div className="flex items-end gap-6">
          ...
          <p className="font-sans text-[clamp(5.5rem,18vw,16rem)] font-normal leading-[0.78] tracking-tighter text-black">
            ...
            <span className="font-mono text-[0.18em] tracking-tight text-stone-400">
              xyz
            </span>
          </p>
        </div>

        <div className="mt-8 flex items-baseline justify-between gap-8 border-t border-stone-200 pt-5">
          <p className="font-serif text-lg italic leading-snug text-stone-600">
            Seeking beauty &amp; untangling complexity.
          </p>
          <ul className="flex gap-8 font-mono text-xs uppercase tracking-widest text-stone-500">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-2">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-1 flex-col justify-end px-10 pb-12">
            ...
            <p className="mt-10 max-w-sm font-sans text-sm leading-snug text-stone-400">
    ...
    <section id="catalog" className={cn(HERO_MIN, "bg-[#F3F1F0] p-4 text-black")}>
      <div className="flex min-h-0 flex-1 flex-col border border-stone-300 p-3">
        <div className="flex min-h-0 flex-1 flex-col border border-stone-300 px-10 py-7">
          ...
          <ol className="grid grid-cols-2 gap-x-16 border-t border-stone-200 pt-5">
    ...
    <section id="mosaic" className={cn(HERO_MIN, "bg-[#F3F1F0] text-black")}>
      ...
      <div className="grid min-h-0 flex-1 grid-cols-[minmax(280px,0.85fr)_1.35fr] items-center gap-12 px-10 pb-10">
        <div>
          ...
          <p className="mt-6 max-w-sm font-sans text-sm leading-snug text-stone-400">
  ...
  return (
    ...
    >
        ...
        <div className="overflow-hidden">
          <ul className="exp-marquee flex w-max gap-10 pr-10">
            {titleLoop.map((title, index) => (
              <li
                key={`${title}-${index}`}
                className="shrink-0 font-serif text-[clamp(2.8rem,6vw,5.5rem)] italic leading-none tracking-tight text-stone-800"
              >
                {title}
        ...
        <div className="overflow-hidden">
          <ul className="exp-marquee-reverse flex w-max gap-8 pr-8">
            {tagLoop.map((tag, index) => (
              <li
                key={`${tag}-${index}`}
                className="shrink-0 font-mono text-xs uppercase tracking-widest text-stone-400"
              >
                {tag}
              </li>
            ))}
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="pointer-events-auto w-[min(28rem,86vw)] border border-stone-200 bg-[#F3F1F0]/90 px-10 py-10 text-center shadow-[0_12px_40px_rgba(0,0,0,0.06)] backdrop-blur-md">
          <Image
            src="/img/logo.svg"
            alt=""
            width={28}
          ...
          <p className="mt-3 font-serif text-lg italic leading-snug text-stone-600">
            Seeking beauty &amp; untangling complexity.
          </p>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-center px-10 pl-12 pb-8">
        ...
        <p className="font-serif text-[clamp(2.6rem,6.5vw,6rem)] italic leading-[0.9] tracking-tight text-stone-700">
          beauty
        </p>
      ...
      <footer className="flex items-center justify-between border-t border-stone-200 px-10 py-5 pl-12 font-mono text-xs uppercase tracking-widest text-stone-500">
